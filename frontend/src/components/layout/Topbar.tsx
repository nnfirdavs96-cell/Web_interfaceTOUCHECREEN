      ...
      <div className="flex items-center gap-2">
        <div className="relative">
          <button
            ...
            className="flex items-center gap-1.5 rounded-lg p-2 text-sm text-slate-600 transition hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-slate-800"
            aria-label="Language"
          >
          ...
          {langOpen && (
            <div
              className="absolute right-0 top-full z-50 mt-1 w-44 overflow-hidden rounded-lg border border-slate-200 bg-white shadow-lg dark:border-slate-700 dark:bg-slate-900"
              ...
              {LANGS.map((l) => (
                <button
                  ...
                  className={`block w-full px-3 py-2 text-left text-sm hover:bg-slate-50 dark:hover:bg-slate-800 ${
                    l.code === currentLang.code ? "font-medium text-brand" : ""
                  }`}
                >
                  {l.name}
                </button>
